...
const changelog = [
  ...
  },
  {
    ...
    changes: [
      '修复战斗页面Drops列表不显示材料掉落的问题：将activeDrops赋值给enemy.drops，移除渲染层hardmode切片逻辑',
      '修复暴风之力(4001)连击伤害逻辑：将renzoDamageUP加入BattleState，改为乘法倍率（1.5x），支持四神之力叠加',
      '修复玩家宝石(t1=35)属性计算错误：多个宝石加成改为线性叠加，避免指数级增长（3个+2从1000倍修复为28倍）',
    ],
  },
  {
    version: 'v0.0.88',
    ...
    changes: [
      '修复反射镜导致玩家不会死亡的Bug：玩家死亡检查移到反射伤害之前',
      '修复恶魔之魂(t1=4006)错误拥有复活能力：移除resCount和resStatUP加成',
      '只有不灭之力(t1=4000)和四神之力(t1=4004)拥有复活能力',
    ],
  },
  {
    version: 'v0.0.87',
  ...
  },
  {
    ...
    date: '2026-07-17 00:00:00',
    changes: [
      '修复反射镜导致玩家不会死亡的问题：反射伤害杀死敌人后继续检查玩家死亡',
    ],
  },
  {
    version: 'v0.0.85',
    ...
    changes: [
      '魂加成显示优化：字体缩小、间距调整，武器魂红色、防具魂绿色',
      'Sanctuary\'s Blessing描述改为"3连闪避！"',
      'Red Eye +1描述改为"根据获得数量提升15%HP"',
      '修复魂描述[t1]/[t2]参数显示逻辑',
    ],
  },
  {
    ...
    date: '2026-07-16 00:00:00',
    changes: [
      'Accel Hourglass修正：击杀Boss时正确计算BP（获得BP-消耗BP=实际获得）',
      'Red Eye +1添加掉落来源：对应Boss掉落',
      '魂显示位置调整：从Weapon List移到装备栏上方',
    ],
  },
  {
    version: 'v0.0.83',
