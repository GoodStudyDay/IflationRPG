...
const mapDataPath = path.join(path.dirname(new URL(import.meta.url).pathname), '../others/map_data.csv');
const bossDataPath = path.join(path.dirname(new URL(import.meta.url).pathname), '../others/boss_data.csv');
const mapDataOutputPath = path.join(path.dirname(new URL(import.meta.url).pathname), '../src/data/mapData.ts');
const bossDataOutputPath = path.join(path.dirname(new URL(import.meta.url).pathname), '../src/data/bossData.ts');
